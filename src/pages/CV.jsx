        ...
        >
          ...
          <div className="border-b border-[#8FA49D]/30 pb-6 mb-8">
            ...
            <a
              ...
              className="mt-4 inline-flex items-center gap-2 px-4 py-2 bg-[#B26450] text-white rounded-full text-sm font-medium hover:bg-[#9d5644] transition-colors shadow-sm"
            >
