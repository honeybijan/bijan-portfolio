        ...
        >
          <div className="p-8 md:p-12">
            <div className="flex items-start justify-between gap-4">
              <div>
                <span className="inline-block px-2.5 py-0.5 bg-amber-100 text-amber-800 text-xs font-medium rounded-full mb-3">
                  Sports Analytics
                </span>
                <h3 className="text-2xl md:text-3xl font-bold text-stone-900">LACCTiC</h3>
              ...
              <a
                ...
                className="shrink-0 p-3 rounded-lg border border-stone-200 text-stone-400 hover:text-amber-700 hover:border-amber-200 hover:bg-amber-50 transition-all"
              >
                <ExternalLink className="w-5 h-5" />
              </a>
            </div>

            <p className="mt-6 text-stone-600 leading-relaxed max-w-3xl">
            ...
            <div className="mt-8 bg-stone-50 rounded-xl p-6 border border-stone-100">
              <h4 className="font-semibold text-stone-900 text-sm mb-3">How it works</h4>
            ...
            <div className="mt-6 flex flex-wrap gap-2">
              {["React", "Django", "Python", "AWS", "Statistics", "Cross Country"].map((tag) => (
                <span
                  key={tag}
                  className="px-3 py-1 rounded-full bg-stone-100 text-stone-500 text-xs font-medium"
                >
                  {tag}
                </span>
              ))}
