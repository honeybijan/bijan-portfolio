  ...
  return (
    <div>
      ...
      <section className="max-w-6xl mx-auto px-6 py-16">
        <h3 className="text-lg font-semibold text-stone-400 uppercase tracking-wider text-xs mb-8">
          Research Areas
        </h3>
      ...
      <section className="bg-stone-50 border-t border-stone-100">
        <div className="max-w-6xl mx-auto px-6 py-16">
          <div className="flex items-center justify-between mb-8">
            <h3 className="text-lg font-semibold text-stone-400 uppercase tracking-wider text-xs">
              Publications
            </h3>
            <a
