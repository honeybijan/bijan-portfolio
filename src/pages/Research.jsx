      ...
      <section className="bg-[#CDDACA]">
        <div className="max-w-6xl mx-auto px-6 py-16">
          ...
          >
            ...
            />
            <h3 className="text-2xl font-bold mb-3"><span className="text-[#E8DFD0]">The</span> <span className="text-[#41A56C]">CEDAR</span> <span className="text-[#E8DFD0]">Lab</span></h3>
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-6 py-3 bg-[#41A56C] text-[#111310] rounded-full font-medium hover:bg-[#35844c] transition-colors shadow-sm"
            >
