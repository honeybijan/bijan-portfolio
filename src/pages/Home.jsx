            ...
            >
              ...
              <div className="mt-4 space-y-1">
                <p className="text-lg text-[#243336] font-medium">
                  Assistant Professor —{" "}
                  <a href="https://engineering.dartmouth.edu/" target="_blank" rel="noopener noreferrer" className="text-[#243336] hover:text-[#49636e] underline decoration-[#243336]/30 underline-offset-2">
                    Dartmouth Engineering
                  </a>
                </p>
                <p className="text-base text-[#243336]">
                  Visiting Scientist —{" "}
                  <a href="https://www.ericandwendyschmidtcenter.org/" target="_blank" rel="noopener noreferrer" className="text-[#243336] hover:text-[#49636e] underline decoration-[#243336]/30 underline-offset-2">
              ...
              <p className="mt-6 text-[#243336] leading-relaxed max-w-xl">
                I lead the{" "}
                <a href="https://cedarlab.dartmouth.edu" target="_blank" rel="noopener noreferrer" className="text-[#B26450] hover:text-[#9d5644] underline decoration-[#B26450]/30 underline-offset-2 font-bold">
                  Dartmouth CEDAR Lab
                </a>
                , where I work on information-theoretical questions pertaining to causality, experimental design, and artificial intelligence. My work addresses new computational challenges in defense and biology. I am also an internationally competitive distance runner and the developer of{" "}
                <a href="https://www.lacctic.com/" target="_blank" rel="noopener noreferrer" className="text-[#243336] hover:text-[#49636e] underline decoration-[#243336]/30 underline-offset-2">
                  LACCTiC
                </a>.
              </p>
              ...
              <div className="mt-6 flex flex-wrap gap-2">
                {interests.map((interest) => (
                  <span
                    key={interest}
                    className="px-3 py-1.5 rounded-full bg-white/60 text-[#243336] text-xs font-medium"
                  >
                    {interest}
                  </span>
                ))}
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                <a
                  ...
                  className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#B26450] text-white rounded-full text-sm font-medium hover:bg-[#9d5644] transition-colors shadow-sm border border-[#243336]/20"
                >
